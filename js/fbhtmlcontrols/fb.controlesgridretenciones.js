...
(function () {
    namespace("FormsBuilder.Modules", ControlesGridRetenciones, loadedUIControlesGridRetenciones, loadRetenciones, initMassive, deleteRetenciones);
    ...
    function UpdateData(data) {
        for (var key in data) {
            try {
                ...
                console.log("Error: " + e.message + " - " + key);
            }
        }
    }
